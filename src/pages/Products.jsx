                ...
                <div className="mt-24 relative rounded-3xl overflow-hidden group">
                    ...
                    <div className="relative z-10 p-12 md:p-20 flex flex-col md:flex-row items-center justify-between gap-10">
                        ...
                        <div className="flex-shrink-0">
                            <Link to="/contact" className="inline-flex items-center gap-2 bg-ventalo-orange text-white px-10 py-5 rounded-xl font-bold hover:bg-orange-600 transition-all transform hover:-translate-y-1 shadow-[0_10px_30px_-10px_rgba(249,115,22,0.5)]">
