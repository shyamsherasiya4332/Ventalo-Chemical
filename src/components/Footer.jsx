            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-8 mb-12">
                    ...
                    <div className="lg:col-span-3">
                        <Link to="/products" className="inline-block group" onClick={() => window.scrollTo(0, 0)}>
                        ...
                        <ul className="space-y-4">
                            ...
                            <li>
                                <a href="mailto:info@ventalochemical.com" className="flex items-center gap-3 group">
                                    ...
                                    <span className="text-gray-400 text-xs group-hover:text-gray-200 transition-colors">info@ventalochemical.com</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <div className="border-t border-white/10 pt-6 flex flex-col md:flex-row justify-between items-center gap-4">
                    ...
                    <div className="flex items-center gap-2 group">
                        ...
                        <p className="text-gray-400 text-[10px] tracking-[0.15em] uppercase font-semibold group-hover:text-gray-200 transition-colors cursor-default">
                            Designed & Developed by <span className="text-ventalo-orange group-hover:text-white transition-colors">Shyam Sherasiya</span>
                        </p>
                    </div>
                </div>
            </div>
