...
function ContactContent() {
    ...
    return (
        <div className="bg-ventalo-light min-h-screen">
            {/* Hero Section */}
            <div className="bg-ventalo-blue text-white relative overflow-hidden h-auto min-h-[40vh] md:h-[50vh] flex items-center py-12 md:py-0">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
                    ...
                    <div className="lg:col-span-4 space-y-8">
                        <div className="bg-ventalo-blue rounded-[2.5rem] p-10 relative overflow-hidden shadow-2xl border border-white/10 text-white h-full transform hover:-translate-y-2 transition-transform duration-500">
                            {/* Decorative Elements */}
                            <div className="absolute top-0 right-0 w-64 h-64 bg-ventalo-orange rounded-full blur-[100px] opacity-20 -translate-y-1/2 translate-x-1/2 pointer-events-none"></div>
                            <div className="absolute bottom-0 left-0 w-48 h-48 bg-blue-500 rounded-full blur-[80px] opacity-20 translate-y-1/2 -translate-x-1/2 pointer-events-none"></div>
                            ...
                            <div className="relative z-10">
                                ...
                                <div className="space-y-10">
                                    ...
                                    <a href="mailto:info@ventalochemical.com" className="flex items-start gap-5 group cursor-pointer">
                                        <div className="p-3.5 bg-white/10 rounded-2xl text-ventalo-orange border border-white/10 backdrop-blur-md group-hover:bg-ventalo-orange group-hover:text-white transition-all duration-300 shadow-lg">
                                            <Mail size={22} />
                                        </div>
                                        <div>
                                            <p className="font-bold text-white text-lg mb-1 group-hover:text-ventalo-orange transition-colors">Email Address</p>
                                            <p className="text-blue-100 font-medium text-lg group-hover:text-white transition-colors">info@ventalochemical.com</p>
                                        </div>
                                    </a>
                                </div>
                            </div>
                            ...
                            <div className="mt-12 pt-12 border-t border-white/10">
                                ...
                                <div className="flex gap-4">
                                    {[
                                        { Icon: Facebook, link: 'https://facebook.com/ventalochemical/' },
                                        { Icon: Instagram, link: 'https://www.instagram.com/ventalochemical' },
                                        { Icon: Linkedin, link: 'https://linkedin.com/company/ventalochemical/' }
                                    ].map(({ Icon, link }, idx) => (
                    ...
                    <div className="lg:col-span-8" id="contact-form">
                        <div className="bg-white p-6 md:p-16 rounded-[2.5rem] md:rounded-[3rem] shadow-[0_25px_50px_-12px_rgba(0,0,0,0.05)] border border-gray-100 relative overflow-hidden isolate">
                            {/* Decorative pulsing circle */}
                            <div className="absolute -top-40 -right-40 w-96 h-96 bg-ventalo-blue/5 rounded-full blur-3xl opacity-50 animate-float pointer-events-none"></div>
                            <div className="absolute -bottom-20 -left-20 w-80 h-80 bg-ventalo-orange/5 rounded-full blur-3xl opacity-50 animate-float pointer-events-none" style={{ animationDelay: '2s' }}></div>
...
export default function Contact() {
    return (
        <Suspense fallback={<div className="min-h-screen flex items-center justify-center"><Loader2 className="animate-spin text-ventalo-orange" size={48} /></div>}>
            <ContactContent />
        </Suspense>
    );
}
