...
export default function Home() {
  return (
    <div className="bg-ventalo-light overflow-x-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 py-20 md:py-32">
          <div className="max-w-5xl">
            ...
            <div className="flex flex-col sm:flex-row gap-6 animate-[slide-up_1.2s_ease-out_0.4s_both]">
              <Link href="/products" className="bg-ventalo-orange text-white px-10 py-5 rounded-full font-bold text-lg hover:bg-orange-500 transition-all shadow-[0_10px_40px_-10px_rgba(249,115,22,0.5)] hover:shadow-[0_20px_60px_-10px_rgba(249,115,22,0.6)] transform hover:-translate-y-1 flex items-center justify-center gap-3 group">
                Explore Products <ArrowRight size={20} className="group-hover:translate-x-1 transition-transform" />
              </Link>
              <Link href="/contact?type=quote" className="group bg-white/5 backdrop-blur-md border border-white/20 text-white px-10 py-5 rounded-full font-bold text-lg hover:bg-white hover:text-ventalo-blue transition-all flex items-center justify-center gap-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <Link
                href="/about"
                key={idx}
                className="glass-card p-6 md:p-10 rounded-[2rem] flex flex-col items-start gap-6 hover:-translate-y-3 transition-transform duration-500 group animate-[slide-up_1s_ease-out_both]"
      ...
      {/* Stats Section */}
      <section className="py-12 md:py-20 bg-ventalo-blue relative overflow-hidden text-white">
      ...
      <section className="py-24 bg-white relative">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="text-center mt-16">
            <Link href="/products" className="group inline-flex items-center gap-2 font-bold text-ventalo-blue text-lg hover:text-ventalo-orange transition-colors">
              View Full Catalogue
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div>
              ...
              <div className="mt-10">
                <Link href="/about" className="inline-block bg-white text-ventalo-dark px-8 py-3 rounded-lg font-bold hover:bg-gray-100 transition-colors transform hover:-translate-y-1">
                  Read Our Story
                </Link>
              </div>
            </div>
      ...
      <section className="py-24 bg-gray-50 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
          ...
          <Link href="/contact?type=quote" className="inline-block bg-ventalo-blue text-white px-12 py-5 rounded-full font-bold text-lg shadow-xl hover:bg-ventalo-dark transition-all transform hover:-translate-y-1 hover:shadow-2xl">
            Get a Quote Today
          </Link>
        </div>
      </section>
