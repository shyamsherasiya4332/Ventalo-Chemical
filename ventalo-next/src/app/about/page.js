...
export default function About() {
    return (
        <div className="bg-ventalo-light overflow-x-hidden">
            {/* Header */}
            <div className="bg-ventalo-blue text-white py-20 md:py-32 relative overflow-hidden">
            ...
            <div className="bg-ventalo-dark text-white py-12 md:py-24 relative overflow-hidden">
